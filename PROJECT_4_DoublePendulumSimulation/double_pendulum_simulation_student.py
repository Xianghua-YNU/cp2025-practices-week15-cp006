...
def animate_double_pendulum(t_arr, sol_arr, L_param=L_CONST, skip_frames=10):
    ...
    ax = fig.add_subplot(111, autoscale_on=False, xlim=(-2 * L_param - 0.1, 2 * L_param + 0.1),
...
if __name__ == "__main__":
    ...
    if energy_variation < 1e-5:
        ...
        print(
            f"Energy conservation target (< 1e-5 J) NOT met. Variation: {energy_variation:.2e} J. Try increasing t_points or tightening odeint tolerances.")
    ...
    if run_animation:
        ...
        anim_object = animate_double_pendulum(t_solution, sol_solution, L_param=L_CONST, skip_frames=max(1,
                                                                                                         t_points_sim // 1000) * 5)  # Adjust skip_frames for desired animation speed/length
